...
@implementation ABFBrightnessView

+ (instancetype)sharedBrightnessView {
    static ABFBrightnessView *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[ABFBrightnessView alloc] init];
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.backImage = ({
            ...
            imgView.image        = [UIImage imageNamed:@"ABFPlayer_brightness"];
