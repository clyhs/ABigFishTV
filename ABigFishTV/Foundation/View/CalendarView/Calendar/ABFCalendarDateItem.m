...
@implementation ABFCalendarDateItem
...
- (void)setSelected:(BOOL)isSelected
{
    ...
    // 字体颜色
    UIColor *textColor = RGB_255(144, 144, 144);    // 非当天([NSDate date])字体颜色
...
- (void)setupSelectedBackgroundViewWithState:(BOOL)isSelected
{
    ...
    if (isSelected)
    {
        ...
        if (self.dayItemModel.isCurrentDate)
        {
            self.selectedBackgroundView.backgroundColor = COMMON_COLOR;
        }
        else
        {
...
- (void)setupSelectedBackgroundView
{
    ...
    self.selectedBackgroundView.layer.borderColor = COMMON_COLOR.CGColor;
