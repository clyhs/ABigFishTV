...
-(void)submitClick:(id)sender{
    ...
    if([AppDelegate APP].user){
        ...
        [PPNetworkHelper uploadImagesWithURL:fullUrl parameters:params name:names[0] images:[self.selectedPhotos mutableCopy] fileNames:[fileNames mutableCopy] imageScale:1.0f imageType:@"png" progress:^(NSProgress *progress) {
